...
const team = [
  ...
  },
  {
    ...
    role: "Producer",
    image: danImg,
    bio: "Dan is the Son-in-law of Mark Ivancic, and later to become videographer, video producer, website designer/ editor and anything related to technology.\n\nOver the years, Mark and I collaborated on hosting a number of youth empowerment events in the greater Edmonton area. We both share a hobby for the outdoors and enjoy hiking, climbing and scrambling in the Canadian Rockies. By day Dan is a project manager for a local shallow utility contractor. Significant projects on his portfolio includes the Fort Edmonton Park Utilities Enhancement, Imagine Jasper Avenue, Blatchford - carbon neutral community and various large scale airfield lighting projects for the Edmonton International.\n\nFrom 2007 to 2020 Dan held a volunteer director position for a not-for-profit charity named the Evan Grykuliak Memorial Society (EGMS), the charity's mandate involved youth bullying prevention through leadership initiatives. Our flagship fund raising event Kicking Out Bullying (3v3 soccer tournament) provided funding to assist in the implementation for programs that aligned with our vision in schools across Alberta (Olweus Bullying Prevention and/or Leader in Me).\n\nIn 2015 and 2016, Mark and Dan hosted the Power in Me - a youth empowerment day with a collection of speakers followed by entertainers in an engaging and inspiring event geared toward overcoming life's obstacles. These events were held at the Northlands Expo center Hall D and boasted attendance of upwards of 3000 students.\n\nFrom the first time I met Mark till today, he is an educator, motivator, and always does his best to spread positive messaging even through the darkest days.",
