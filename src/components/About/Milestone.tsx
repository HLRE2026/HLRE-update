...
export function Milestone({ year, title, description, isLast = false }: MilestoneProps) {
  return (
    <div className="relative pl-8 pb-8">
      {!isLast && (
        <div className="absolute left-[11px] top-[24px] w-[2px] h-full bg-primary-200" />
      )}
      <div className="absolute left-0 top-[6px] w-6 h-6 rounded-full bg-primary-600 border-4 border-white shadow-sm" />
      <div className="pt-1">
