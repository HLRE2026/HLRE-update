      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-4">
            Our goal is $300,000. The first $100,000 covers documentary production costs. All funds raised beyond $100,000 will go directly to the Glenrose Hospital Foundation and the Canadian Mental Health Association, Edmonton Region (CMHA Edmonton)
          </p>
